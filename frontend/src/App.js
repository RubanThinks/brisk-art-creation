...
import './App.css';
import { MapPin, Mail, Phone, Instagram, Linkedin, Home, Paintbrush, HardHat, Menu, X } from 'lucide-react';
...
function App() {
  ...
  const portfolioItems = [
    { title: 'Residence', subtitle: 'Light & Line', image: 'https://images.unsplash.com/photo-1549791084-5f78368b208b?w=800&q=80' },
    { title: 'Studio', subtitle: 'Material Rhythm', image: 'https://images.unsplash.com/photo-1520529890308-f503006340b4?w=800&q=80' },
    { title: 'Atrium', subtitle: 'Vertical Balance', image: 'https://images.unsplash.com/photo-1592274951725-1688461e2019?w=800&q=80' },
    { title: 'Lounge', subtitle: 'Warm Minimal Edges', image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80' },
    { title: 'Workspace', subtitle: 'Graphic Silence', image: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80' },
    { title: 'Villa', subtitle: 'Geometric Harmony', image: 'https://images.unsplash.com/photo-1548248823-ce16a73b6d49?w=800&q=80' }
  ];
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Every surface, line, and light plane is guided by intention. We shape environments
              where proportion becomes beauty and where purpose is engineered into the smallest detail.
            </p>
          </div>
          ...
          <div className="flex-1 flex justify-center md:justify-end">
            <img
              src="/about-image.png"
              alt="About"
              className="w-32 h-32 md:w-56 md:h-56 rounded-full object-cover shadow-xl border-4 border-white"
            />
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            <div className="service-card">
              <div className="service-icon"><Home strokeWidth={1.5} size={48} /></div>
              <h3>Architecture</h3>
              <p>Form, function, and flow unified through geometry.</p>
            </div>
            <div className="service-card">
              <div className="service-icon"><Paintbrush strokeWidth={1.5} size={48} /></div>
              <h3>Interior Design</h3>
              <p>Material balance and light harmony.</p>
            </div>
            <div className="service-card">
              <div className="service-icon"><HardHat strokeWidth={1.5} size={48} /></div>
              <h3>Construction</h3>
