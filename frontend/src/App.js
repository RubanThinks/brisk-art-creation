    ...
    <div className="App">
      ...
      <section id="about" className="about-section">
        <div className="container about-flex">
          ...
          <div className="about-image">
            <img 
              src="https://your-image-url-here.com/about.jpg" 
      ...
      <footer id="contact" className="footer">
        <div className="container footer-grid">
          ...
          <div>
            <h4>Contact</h4>
            <a href="https://maps.app.goo.gl/5rZBsjyGbAdubXJc6?g_st=aw" target="_blank" rel="noreferrer">
              <MapPin size={18} /> 4/149, Mangayarkarasi Street, Fairlands, Salem – 636016
            </a>
            <a href="tel:+919655724488"><Phone size={18} /> +91 96557 24488</a>
            <a href="mailto:briskartcreation@gmail.com"><Mail size={18} /> briskartcreation@gmail.com</a>
            <a href="https://instagram.com/briskartandcreation" target="_blank" rel="noreferrer"><Instagram size={18} /> @briskartandcreation</a>
            <a href="https://www.linkedin.com/in/brisk-art-creation-555aa91aa" target="_blank" rel="noreferrer"><Linkedin size={18} /> Brisk Art Creation</a>
          </div>
        </div>
