...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* About Section (without image placeholder) */}
          ...
          <div className="about-content">
            <div className="about-text">
              ...
              <div className="about-description">
                <p>
                  At Brisk Art and Creation, we believe space is not just built
                  — it is <em>composed</em>.
                </p>
                <p>
                  Every surface, line, and light plane is guided by intention.
                  We shape environments where proportion becomes beauty, and
                  where purpose is engineered into the smallest detail.
                </p>
              </div>
            </div>
            ...
            <div className="footer-col">
              ...
              <div className="contact-info">
                ...
                >
                  ...
                  <span>
                    4/149, Mangayarkarasi street, Balaji Nagar, Fairlands
                    <br />
                ...
                <a
                  href="mailto:briskartcreation@gmail.com"
                  className="contact-item"
                >
